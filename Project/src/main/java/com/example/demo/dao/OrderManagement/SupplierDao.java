...
public void save(Supplier s) {
		...
		String sql1= "insert into supplier(suppName,location,registeredDate) values ('"+s.getName()+"','"+s.getLocation()+"','"+s.getRegDate()+"')";
...
public void update(Supplier c) {
	...
	String sql= "update supplier set suppName='"+c.getName()+"',location='"+c.getLocation()+"',registeredDate='"+c.getRegDate()+"' where supplierID="+c.getId()+";";
