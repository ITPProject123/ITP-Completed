...
public class ClientController {
	...
	public String deleteData(@RequestParam("clientID") int clientID ,ModelMap model) {
		...
		return "ClientMangament/ClientList";
		
	}
	
//	@RequestMapping("editClient")
//	public String editClient(ModelMap model) {
//		
...
/*	@RequestMapping(value = "/eventLog",method = RequestMethod.GET)
	...
	*/
    ...
    public String saveBranchDetails(@Valid Client client,BindingResult result,ModelMap model,RedirectAttributes redirectAttributes) {
		if(result.hasErrors()) {
			
			return "AddBranch";
		}
		
		clientdao.saveBranch(client);
		return "redirect:/branchList";
	 }*/
	
    @RequestMapping(value = "/savebranch", method = RequestMethod.POST)
	public ModelAndView add(@Valid @ModelAttribute("client") Client client,
			BindingResult result, @RequestParam("clientID") int clientID) {

		clientdao.saveBranch(client, clientID);
		// return new ModelAndView("redirect:/branchList/{id}") ;
		return new ModelAndView("redirect:/branchList");
    }
    ...
    @RequestMapping(value="branchList",method=RequestMethod.GET)
	 ...
	 @RequestMapping(value="/branchList/{clID}",method=RequestMethod.GET)
	 public ModelAndView viewBranchList(@Valid @ModelAttribute("client") Client client,BindingResult result,@RequestParam("clientID") int ID,ModelMap model) {
			
			List<Client> list = clientdao.getAllBranchDeatils(ID);
			
			return new ModelAndView("branchList","list",list);		
