			...
			<h2 align="center" style="margin-top: 2%">Client Orders</h2>
				<table id="t01" class="table table-striped table-bordered">
					...
					<tr>
						...
						<td>
							<c:choose>
								<c:when test="${employee.status}"><a href="/EditClientOrder?id=${employee.oid}">confirmed</a></c:when>
								<c:otherwise><a href="/EditClientOrder?id=${employee.oid}">confirm</a></c:otherwise>
												</c:choose>
						
							</td>
						<td><a href="/EditClientOrder?id=${employee.oid}">Edit</a></td>
						<td><a href="/delete?id=${employee.oid}">Delete</a></td>
					</tr>
				</c:forEach>
