...
<body>
	<div class="container-fluid" style="height: 2000px">
		...
		<div class="row md-auto">
			<div class="col-md-12">
				<form:form  method ="POST" modelAttribute="edvisitor" id="validateForm" class="form-horizontal" action ="/editapp">
  				...
  				<div class="form-group row" style="margin-left: 30%;margin-top: 4%">
    				<label class="control-label col-sm-2" for="appcode">Appointment ID</label>
    					<div class="col-sm-4">
      						<form:input type="text" path="appcode" class="form-control" id="appcode" name ="appcode"/>
      						</div>
    					</div>
