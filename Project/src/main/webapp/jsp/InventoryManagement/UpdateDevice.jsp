...
<body>
	...
	<br><br>
		...
		<div class="row md-auto">
			<div class="col-md-12">
				<form:form  method ="POST" modelAttribute="device" class="form-horizontal form-responsive" action = "/editsave">
 	 			...
 	 			<div class="form-group row" style="margin-left: 30%;margin-top: 2%">
    				<label class="control-label col-sm-2" for="suppID">SupplierID</label>
    					<div class="col-sm-4">
      						<form:input type="text" path="suppID" class="form-control" id="suppID"/>
      						<div class = "has-error">
      						<form:errors path="suppID" class="help-inline"/>
      						</div>
    					</div>
 	 			</div>
