...
<div class="container-fluid" style="height:100%">
 	...
 	<div class="col md-5 mt-5 ">
      					<a href="employeePayments"><button type="reset" class="btn btn-primary">Employee Payment</button></a>
    				</div>
      </div>
	  	 <div class="form-group row">
      <div class="col md-5 offset-3 mt-5 ">
 	...
 	<div class="col md-5 mt-5 ">
      					<a href="Supplier-Order.html"><button type="reset" class="btn btn-primary">Supplier Payments</button></a>
