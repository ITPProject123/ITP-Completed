<%@page import="com.example.demo.controller.PaymentManagement.DashboardController"%>
			...
			new Chart(document.getElementById("pie-chart"), 
			{
    			...
    			data: 
    			{
      				...
      				[
        			{
				        ...
				        data: [<%=DashboardController.chartX()%>]
        			}
      				]
    			},
    			...
    			options: 
    			{
      				...
      				{
        				display: true,
        				text: 'Petty Cash Count by Status',
        				fontSize:20,
        				fontStyle:'italic'
      				}
    			}
